...
function ageClassification(n) {
    ...
    n < 0 ? res = null :
        (n > 0 && n <= 24) ? res = 'детский возраст' :
            (n > 24 && n <= 44) ? res = 'молодой возраст' :
                (n > 44 && n <= 65) ? res = 'средний возраст' :
                    (n > 65 && n <= 75) ? res = 'пожилой возраст' :
                        (n > 75 && n <= 90) ? res = 'старческий возраст' :
                            (n > 90 && n <= 122) ? res = 'долгожители' : res = null;
    return res;
}
